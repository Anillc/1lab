...
normal forms to choose from, but the most useful for our task is _Horner
normal form_, as it admits a particularly nice inductive
characterization.
...
This could be alleviated by using a _sparse_ representation, but this is
