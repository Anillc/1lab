...
is _more defined than_ $y$, and they agree on this common extent.
...
In functional programming circles, it's common to define a _partial
function_ $A \to B$ to be a total function $A \to
