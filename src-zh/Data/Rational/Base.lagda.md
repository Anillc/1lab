...
However, clients of this module _will_ need the fact that $\bQ$ is a
...
We now show that the quotient defining $\bQ$ is [[_split_|split
quotient]]: integer fractions have a well-defined notion of _normal
form_, and similarity of fractions is equivalent to equality under
