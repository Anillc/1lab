...
Going up a level, we do _not_ have that the suspension of a proposition is a proposition
(think of the suspension of $\bot$), but we _do_ have that the suspension of a
proposition is a _set_.
...
This time, if $A$ holds, we have to fill a _cube_ with the given four edges:
