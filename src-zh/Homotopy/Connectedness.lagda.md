...
_below_ $n$ are trivial.  A type that is both $n$-truncated and
...
of _propositional_ truncations, with the base case being that all types are
$(n-2)$-connected:
...
can map into the $n$-_truncated_ types. We then expand this idea to
