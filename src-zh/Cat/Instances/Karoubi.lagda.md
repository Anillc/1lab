...
This makes the Karoubi envelope an "idempotent completion" in two _different_ technical
senses^[it is a completion that _adds_ splittings of idempotents, and a completion that _is_ idempotent]!
