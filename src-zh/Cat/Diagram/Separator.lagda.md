...
Many categories lack a single separating object $S : \cC$, but do have a _family_ of
...
but we _can_ if we look at all maps $\yo(A) \to P$! This leads us to the
following notion:
...
object only lets us _equate_ morphisms; ideally, we would be able to
