...
using a variant of _Normalization By Evaluation_ (NbE for short).
...
The particular variant of NbE that we are using is known as _Typed NbE_.
What distinguishes it from _Untyped NbE_ is the treatment of quotation.
...
Next, we define a type of _Values_. The goal here is to ensure that we
...
proof. Marking this as abstract is _very important_. This prevents
...
If we don't do this, Agda will get _very_ upset.
