...
To see why univalence is required, remember that finite types are _merely_ equivalent
to $[n]$, so any two enumerations should yield the same result. But two different
permutations of the objects in a diagram would only yield _isomorphic_ products
