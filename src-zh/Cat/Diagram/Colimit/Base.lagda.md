...
constant functor functor $\{_\} \to \cC$ with value `coapex` to be a Kan
...
Our colimit will arise as a _quotient object_ of this coproduct-of-objects,
...
This suggests to build another indexed coproduct of all the _domains_ of arrows in
