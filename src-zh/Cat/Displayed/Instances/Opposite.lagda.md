...
:::source
The construction formalised here, defined in terms of an _operation_
...
only be relevant in the setting of uncloven fibrations _of
precategories_; we have thus decided to avoid its complexity.
:::
...
and, what concerns us here, _opposite_ categories. Working at the level
