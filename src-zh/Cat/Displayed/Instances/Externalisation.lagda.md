...
_generalised objects_ $\cB(\Gamma, \bC\_0)$.
...
The identity morphism of families can _almost_ be given by the
...
the [[cartesian morphisms]] are _precisely_ the internal isomorphisms.
