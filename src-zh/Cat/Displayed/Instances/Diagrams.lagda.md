...
liftings along a constant functor $\Delta\_{x} : \cJ \to \cB$, we get a
diagram in $\cE$ that lies entirely in the fibre $\cE\_{x}$: a fibrewise
diagram!
...
Again, this isomorphism is _almost_ definitional.
