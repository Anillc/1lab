...
extension, then it preserves _all_ extensions for the same diagram.
...
\cD\]$][Functor-is-category], so our natural isomorphism $i : G\_1 \cong
G\_2$ is equivalent to an identification $i' : G\_1 \equiv G\_2$. Then, our
tiny lemma stating that this isomorphism "sends $\eta\_1$ to $\eta\_2$" is
precisely the data of a dependent identification $\eta\_1 \equiv \eta\_2$
over $i'$.
