...
we get a "composite" $\Lan\_F(H) : D \to E$. With this perspective in
...
G \dashv - \circ F$ means that _left_ ([global]) Kan extensions along
...
Even more dually, we can flip the span above to get a _cospan_ of
