...
$n$ variables is a function $f : M\_0 \to M\_1 \to \dots M\_n \to N$, which
...
If we are given $r : R$, $x, y : M\_i$, we can consider the updated
...
multilinear maps $M\_i \to N$. This is nothing but the pointwise module
